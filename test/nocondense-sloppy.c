...
int main(int argc, const char** argv)
{
    ...
    XOPT_SIMPLE_PARSE(argv[0], XOPT_CTX_SLOPPYSHORTS | XOPT_CTX_NOCONDENSE, &options[0], &config, argc, argv,
                      &extraCount, &extras, &err, stderr, "[opts...] [--] [extras...]", "Tests the simple parser macro",
                      "[end of arguments]", 15);
